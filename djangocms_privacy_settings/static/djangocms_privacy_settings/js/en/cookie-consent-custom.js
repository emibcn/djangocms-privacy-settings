		...
		var settings_dialog = $(
			'<div class="ui-widget ui-corner-all cookieconsent-dialog-content cookieconsent-edit-settings">' +
				...
				'<div class="cookieconsent-level-changer-wrap">' +
					...
					'</div>' +
				'</div>' +
				(config.cookie_policy_url.length > 0?'<a href="'+config.cookie_policy_url+'" class="cookieconsent-cookie-policy-link btn-primary text-center">More</a>':'') +
			'</div>'
		);
				...
				if(config._demo_mode || config.levels.saved() == null){
					var popup = $(
						'<div class="ui-widget ui-corner-top cookieconsent-popup">' +
							...
							(config.cookie_policy_url.length > 0?'<a href="'+config.cookie_policy_url+'" class="cookieconsent-cookie-policy-link btn-primary">More</a>':'') +
